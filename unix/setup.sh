...
ch create csci104 --image usccsci104/docker-multiarch:20.04 --shell /bin/bash --volume "$work:/work" --security-opt seccomp:unconfined --cap-add SYS_PTRACE --privileged --replace
